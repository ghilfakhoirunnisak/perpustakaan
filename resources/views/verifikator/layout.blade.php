...
<head>
    ...
    <title>Dashboard - Verifiktor | Perpustakaan 2025</title>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <!-- Dashboard -->
                    <li class="menu-item {{ Route::is('verifikator.dashboard') ? 'active' : '' }}">
                        <a href="{{ route('verifikator.dashboard') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ Route::is('verifikator.pengajuanbuku.*') ? 'active' : '' }}">
                        <a href="{{ route('verifikator.pengajuanbuku.index') }}" class="menu-link">
                    ...
                    <!-- Fasilitas -->
                    <li class="menu-item {{ Route::is('verifikator.reservasifasilitas.*') ? 'active' : '' }}">
                        <a href="{{ route('verifikator.reservasifasilitas.index') }}" class="menu-link">
