...
@section('content')
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center mb-4">
                        <img id="cover-preview" src="{{ asset('no-cover.png') }}" class="img-fluid rounded shadow"
                            style="max-height: 300px;" alt="Cover Buku">
                    </div>
                ...
                <div class="mt-4 text-end">
                    <a href="{{ route('anggota.buku.index') }}" class="btn btn-secondary">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const id = parts[parts.length - 2]; // karena /anggota/buku/{id}/show
